...
DESENLER = [
    ...
    (r"writefile|appendfile|readfile|delfile|makefolder|listfiles", "DOSYA", 22, "executor dosya sistemi erisimi (yerel veri okuyup/yazabilir)"),
    (r"setclipboard|toclipboard", "VERI", 18, "panoya veri yazma (kopyalanan veri riski)"),
    (r"identifyexecutor|syn\.request|http_request", "EXECUTOR", 10, "executor kimligi veya ozel HTTP API kullanimi"),
    (r"api\.telegram\.org/bot|discord(?:app)?\.com/api/webhooks", "EXFIL", 38, "bilinen veri sizdirma endpointi"),
    (r"https?://\d{1,3}(?:\.\d{1,3}){3}", "EXFIL", 18, "ciplak IP adresine ag baglantisi"),
    ...
    (r"luraph|moonsec", "OBF", 15, "ileri seviye obfuscator/paketleyici imzasi"),
